...
const CODE_TO_I18N_KEY: Record<string, string> = {
  ...
  [ErrorCodes.SHIPMENT_NOT_READY]: 'errors.SHIPMENT_NOT_READY',
  [ErrorCodes.INBOUND_STATE_CONFLICT]: 'errors.INBOUND_STATE_CONFLICT',
  [ErrorCodes.RETURN_STATE_CONFLICT]: 'errors.RETURN_STATE_CONFLICT',
  [ErrorCodes.RETURN_ALREADY_PROCESSED]: 'errors.RETURN_ALREADY_PROCESSED',
  [ErrorCodes.RETURN_LINE_INVALID]: 'errors.RETURN_LINE_INVALID',
  [ErrorCodes.RETURN_QTY_EXCEEDED]: 'errors.RETURN_QTY_EXCEEDED',
  [ErrorCodes.INSUFFICIENT_STOCK]: 'errors.INSUFFICIENT_STOCK',
  [ErrorCodes.OUTBOUND_STATE_CONFLICT]: 'errors.OUTBOUND_STATE_CONFLICT',
  [ErrorCodes.OUTBOUND_LINE_INVALID]: 'errors.OUTBOUND_LINE_INVALID',
  [ErrorCodes.STOCK_BATCH_NOT_FOUND]: 'errors.STOCK_BATCH_NOT_FOUND',
  [ErrorCodes.SALES_STATE_CONFLICT]: 'errors.SALES_STATE_CONFLICT',
  [ErrorCodes.SALES_LINE_INVALID]: 'errors.SALES_LINE_INVALID',
